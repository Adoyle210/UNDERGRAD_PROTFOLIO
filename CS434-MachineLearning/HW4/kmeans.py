...
def toyProblem():
  ...
  for x in range(5):
    ...
    plotClustering(centroids, assignments, X, title="Question Five Clustering")
  ...
  for x in range(1, 150):
    ...
    # plotClustering(centroids, assignments, X, title="Question Six Clustering")
...
def updateCentroids(dataset, centroids, assignments):
  ...
  for x in range(0,row_n):
    centID = assignments[x]
    sums[centID] += dataset[x]
    counts[centID] += 1
